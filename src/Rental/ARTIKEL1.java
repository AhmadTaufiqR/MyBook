 ...
 * @author HP
 */
public class ARTIKEL1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_artikel = new javax.swing.JLabel();
        ...
        txt_artikel.setBackground(new java.awt.Color(255, 255, 255));
        txt_artikel.setFont(new java.awt.Font("Lucida Sans", 1, 24)); // NOI18N
        txt_artikel.setForeground(new java.awt.Color(255, 255, 255));
        txt_artikel.setText("ARTIKEL");
        txt_novel.add(txt_artikel, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 40, -1, -1));

        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Menu/bg.png"))); // NOI18N
        txt_novel.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 160, -1, -1));
    ...
    private void btn_populerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_populerActionPerformed
        ...
        new Pop_Artikel().setVisible(true);
    ...
    private void btn_terbaruActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_terbaruActionPerformed
        // TODO add your handling code here:
        this.setVisible(false);
        new Tab_Artikel().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ARTIKEL1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel txt_artikel;
